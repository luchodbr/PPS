...
const routes = [
    ...
    {
        path: 'registro',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-registro-registro-module */ "common").then(__webpack_require__.bind(null, /*! ./pages/registro/registro.module */ "./src/app/pages/registro/registro.module.ts")).then(m => m.RegistroPageModule)
    },
];
...
module.exports = __webpack_require__(/*! /home/aleksei/workspace/Practica_Profesional_Supervisada/1_Login/src/main.ts */"./src/main.ts");
